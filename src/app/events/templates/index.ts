...
import {
    ...
    workflowRequestActionRequiredClient,
    workflowRequestCompletedClient,
...
const registry: Record<string, EmailTemplate> = {
    ...
    order_pending_approval_admin: orderPendingApprovalAdmin,
    ...
    workflow_request_action_required_client: workflowRequestActionRequiredClient,
    ...
    workflow_request_completed_client: workflowRequestCompletedClient,
    ...
    self_pickup_declined_client: selfPickupDeclinedClient,
    self_pickup_declined_admin: selfPickupDeclinedAdmin,
