...
const sendNotification = async (
    ...
    const recipients =
        overrideRecipients ||
        (await getRecipientsForNotification(platformId, notificationType, order.contact_email));
...
// ----------------------------------- SEND NOTIFICATION FOR INBOUND REQUEST ------------------
// const sendNotificationForInboundRequest = async (
//     platformId: string,
//     notificationType: NotificationType,
//     payload: any,
//     overrideRecipients?: Partial<NotificationRecipients>,
...
export const NotificationLogServices = {
    ...
    retryNotification,
    // sendNotificationForInboundRequest,
};
