...
const getCalendarEvents = async (query: CalendarQueryParams, user: any, platformId: string) => {
    ...
    const conditions: any[] = [eq(orders.platform_id, platformId), isNull(orders.deleted_at)];
