...
opsRouter.get("/", platformValidator, auth("ADMIN", "LOGISTICS"), ReportsControllers.listReportsOps);
opsRouter.get("/:key/run", platformValidator, auth("ADMIN", "LOGISTICS"), ReportsControllers.runReportOps);

const clientRouter = express.Router();
clientRouter.get("/", platformValidator, auth("CLIENT"), ReportsControllers.listReportsClient);
clientRouter.get("/:key/run", platformValidator, auth("CLIENT"), ReportsControllers.runReportClient);
