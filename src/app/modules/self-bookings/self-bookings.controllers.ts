...
const getSelfBookingById = async (req: Request, res: Response) => {
    ...
    const result = await SelfBookingsServices.getSelfBookingById(id, platformId);
...
const returnScan = async (req: Request, res: Response) => {
    ...
    const result = await SelfBookingsServices.returnScan(id, platformId, req.body);
...
const cancelSelfBooking = async (req: Request, res: Response) => {
    ...
    const result = await SelfBookingsServices.cancelSelfBooking(id, platformId, user.id, req.body);
