...
export const seedDemoCatalog = async (opts: SeedDemoCatalogOpts): Promise<SeededCatalog> => {
    ...
    // ─── Families ────────────────────────────────────────────
    await db.insert(schema.legacyAssetFamilies).values([
        {
    ...
    await db.insert(schema.assets).values([
        // Event Chairs — POOLED batch
        {
            ...
            brand_id: opts.brandPrimaryId,
            group_id: DEMO_UUIDS.families.eventChairs,
        ...
        // Backdrop Panels — SERIALIZED, condition mix
        {
            ...
            brand_id: opts.brandPrimaryId,
            group_id: DEMO_UUIDS.families.backdropPanels,
        ...
        // LED Screens — SERIALIZED, all GREEN
        {
            ...
            brand_id: opts.brandSecondaryId,
            group_id: DEMO_UUIDS.families.ledScreens,
            name: "LED Screen #1",
            category: "AV Equipment",
            stock_mode: "SERIALIZED",
            total_quantity: 1,
        ...
        // FOR UPDATE lock; one wins (available 1 → 0), the other rejects.
        {
            ...
            brand_id: opts.brandPrimaryId,
            group_id: DEMO_UUIDS.families.singleStockTest,
